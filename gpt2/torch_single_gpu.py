"""
This code has been borrowed from Karpathy's original implementation
of GPT-2. The code has been modified a bit to make it as minimal as
possible. You can find the original source code here:
